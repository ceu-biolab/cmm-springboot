...
public class SpectrumScorerTest {
    ...
    void setUp() {
        ...
        scorer = new SpectrumScorer(ToleranceMode.mDA, 0.1,145.0);
    }
    ...
    void testPaddingNormalizedSpectra() {
        ...
        SpectrumScorer scorer = new SpectrumScorer(ToleranceMode.mDA, 0.5, 145.0);
    ...
    void testCosineScore() {
        ...
        assertEquals(0.8966,score, 1e-4,"Cosine score between spec1 and spec2 should be approximately 0.408469");
    }
    @Test
    void testModifiedCosine() {
        ...
        assertEquals(1.0,score, 1e-4,"Modified cosine score between spec1 and spec2 should be approximately 0.408469");
    }
}
