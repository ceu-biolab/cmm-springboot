...
public class CompoundBatchSearchRequestDTO {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(mzValues, that.mzValues) && mzToleranceMode == that.mzToleranceMode && Objects.equals(tolerance, that.tolerance) && ionizationMode == that.ionizationMode && Objects.equals(detectedAdduct, that.detectedAdduct) && Objects.equals(adductsString, that.adductsString) && Objects.equals(databases, that.databases) && metaboliteType == that.metaboliteType;
    }

    @Override
    public int hashCode() {
        return Objects.hash(mzValues, mzToleranceMode, tolerance, ionizationMode, detectedAdduct, adductsString, databases, metaboliteType);
    }
